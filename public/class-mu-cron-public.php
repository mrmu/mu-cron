...
class Mu_Cron_Public {
	...
	public function __construct( $plugin_name, $version ) {
		...
		$this->general_settings = Mu_Cron_Settings_Factory::get_instance('general');
	}
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( 
			$this->plugin_name, 
			plugin_dir_url( __FILE__ ) . 'css/mu-cron-public.css', 
			array(), 
			filemtime( (dirname( __FILE__ )) . '/css/mu-cron-public.css' ),
			'all' 
		);
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 
			$this->plugin_name, 
			plugin_dir_url( __FILE__ ) . 'js/mu-cron-public.js', 
			array( 'jquery' ), 
			filemtime( (dirname( __FILE__ )) . '/js/mu-cron-public.js' ),
			false 
		);
		wp_localize_script(
			$this->plugin_name,
	...
	public function register_shortcodes() {
		add_shortcode( 'mu_cron_form', array($this, 'mu_cron_form_display') );
	}

	public function mu_cron_form_display( $atts, $content = '' ) {
		if (is_admin()) {
			return;
		}
